//   simonKey96_144(jumlah m,jumlah round, kunci)
void simonKey96_144(int SIMON_M,int SIMON_T,uint64_t *k)
{
  uint64_t tmp,tmp2;
    ...
    {  
        ...
        k[i] = (~k[i-SIMON_M]&0x0000ffffffffffff) ^ tmp ^ z[3][i-SIMON_M] ^ 3;
...
void simonEnc96_144(int SIMON_M,int SIMON_T,uint64_t *key,uint64_t *cword)
{
  uint64_t crypt[1];
  uint64_t tmp;
  crypt[0]= cword[0];
