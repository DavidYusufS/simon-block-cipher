...
void simonKey48_96(int SIMON_M,int SIMON_T,uint32_t *k)
{
  uint32_t tmp,tmp2;
    ...
    {  
        ...
        k[i] = (~k[i-SIMON_M]&0x00ffffff) ^ tmp ^ z[1][i-SIMON_M] ^ 3;
//        Serial.print(i);Serial.print(". ");
//        Serial.println(k[i],HEX);
    }
}

void simonEnc48_96(int SIMON_M,int SIMON_T,uint32_t *key,uint32_t *cword)
{
  uint32_t crypt[1];
  u32 tmp;
  crypt[0]= cword[0];
